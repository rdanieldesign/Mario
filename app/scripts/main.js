$(document).keydown(function(e) {
    ...
    switch(e.which) {
        case 37: // left
        if ((backgroundPosTop - backgroundHeight > 0) || (backgroundPosTop + backgroundHeight <= 200) || (backgroundPosRight > 440) || (backgroundPosRight + backgroundWidth <= 440)){
        ...
        case 39: // right
		if ((backgroundPosTop - backgroundHeight > 0) || (backgroundPosTop + backgroundHeight <= 200) || (backgroundPosRight + backgroundWidth <= 360) || (backgroundPosRight >= 440)){
        $('#background').css( "right", backgroundPosRight + 40 + "px");};
        break;
...
characterOffset.html( "left: " + characterOffset.left + ", top: " + characterOffset.top );